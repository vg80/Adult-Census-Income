...
boxplot(adult$age, main = "boxplot of age")
...
```{r}
ggplot(adult, aes(age,color= income)) + geom_density()
```
...
ggplot(adult, aes(x = adult$occupation, fill = adult$income)) +
  ...
  labs(x = "Income", 
       y = "Number of people",
       fill = "Income") +
  ggtitle("Income grouped by occupation") +   
...
ggplot(adult, aes(x = adult$nativecountry, fill = adult$income)) +
  ...
  labs(x = "Income", 
       y = "Number of people",
       fill = "Income") +
  ggtitle("Income grouped by Native Country") +   
  scale_y_continuous(breaks = seq(0,20000,1000))
...
ggplot(adult, aes(x = adult$education, fill = adult$income)) +
  geom_bar(position = "stack",na.rm = FALSE) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(x = "Income", 
       y = "Number of people",
       fill = "Income") +
  ggtitle("Income grouped by education") +   
  scale_y_continuous(breaks = seq(0,20000,1000))

# Percentage of occupation categories with income <50K and >=50K:
prop.table(table(adult$education, adult$income), margin = 1)*100
```
```{r}
par(mfrow=c(2,2))
