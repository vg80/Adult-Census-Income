...
plot(roc_rf, col = "red")
roc_svm = roc(predictor = as.numeric(predictions_svm), as.numeric(Adult_dummy_del[,"income"]))
plot(roc_svm, add = T, col= "purple")
roc_gbm = roc(predictor = as.numeric(predictions_gbm), as.numeric(Adult_dummy_del[,"income"]))
plot(roc_gbm, add = T, col = "black")
roc_glm = roc(predictor = as.numeric(predictions_glm), as.numeric(Adult_dummy_del[,"income"]))
plot(roc_glm, add = T, col = "green")
...
top_models = data.frame(predictions_knn,predictions_rf,predictions_svm, predictions_gbm, predictions_glm) 

#GBM as top layer model 
ensemble_gbm = train(top_models,Adult_dummy_del[,"income"],method='rf',trControl= ctrl,tuneLength=3)
```