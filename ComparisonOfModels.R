...
Resamples_imputed = resamples(list(KNN=KNNFit_imputed, RF= RFFit_imputed,SVM= SVM_imputed,GBM37 = GBMFit_imputed, GLM =GLMFit_imputed, NNet= nnetFit_imputed, GBM20 = gbmFit_imputed))
...
cm_GBM20 = confusionMatrix.train(gbmFit_imputed)
